...
const Swap: React.FC<GetAllTokensProps> = ({ setShowSwapCard }) => {
  ...
  async function getPrice() {
    ...
    const headers = {
      "0x-api-key": "d1676d1a-3e6f-4981-af61-66cc230ee9b5",
    }
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="mx-8 grid grid-cols-2 place-items-end items-center gap-2">
            <div className="flex items-center gap-2 pl-96">
              <Image
            ...
            <div>
              <select
                className="h-[40px] rounded-[6px] bg-[#F2F2F2] px-1 outline-none "
            ...
            <div className="space-y-3 rounded-[10px] p-5">
              <div className="">
                <div className="space-y-3 rounded-[10px] ">
                  {selectedOption1 === "garden" ? <CustomSelect1 /> : null}
                  {selectedOption1 === "gardener" ? <CustomSelect /> : null}
                </div>
              </div>
              ...
              {selectedOption === "volvo" && (
                <div className="mb-6 space-y-3">
                  ...
                  <div className="flex">
                    ...
                    />
                    <span className="flex items-center rounded-r bg-gray-200 px-3">
                      %
                    </span>
                  </div>
                  ...
                  <div className="mt-2 flex justify-center ">
                    <button
                      ...
                      className="mr-2 rounded border px-2 py-1  hover:bg-[#1D39DD] hover:text-white"
                    >
                      25
                    </button>
                    ...
                    <button
                      ...
                      className="rounded border px-2 py-1 hover:bg-[#1D39DD] hover:text-white"
                    >
                      100
                    </button>
                  </div>
                ...
                //       onChange={handleInputChange}
                //       placeholder="Enter percentage (0-100)"
                //       className="mb-2 w-full rounded border px-3 py-2 sm:mb-0 sm:mr-2 sm:w-1/2"
                //     />
                //     <span className="flex items-center rounded bg-gray-200 px-3">
                //       %
                //     </span>
                //   </div>
                ...
                //     <button
                //       onClick={() => handlePercentageClick("25")}
                //       className="mb-2 mr-2 rounded border px-2 py-1  hover:bg-[#1D39DD] hover:text-white"
                //     >
                //       25
                //     </button>
                ...
                //     <button
                //       onClick={() => handlePercentageClick("100")}
                //       className="mb-2 rounded border px-2 py-1 hover:bg-[#1D39DD] hover:text-white"
                //     >
                //       100
                //     </button>
                //   </div>
              ...
              <div className="mb-3 space-y-3">
                ...
                <div>
                  ...
                  <div className="flex cursor-pointer place-items-center justify-between rounded-lg bg-[#F6F6F6] p-2">
                    {selectedLogo1 && selectedName1 && selectedDescription1 ? (
                      <div className="flex gap-1 text-sm">
                        <Image
                          src={selectedLogo1}
                          alt="logo"
